...
import type { DaemonSetEvent } from '../lib/api';
import { formatRelativeTime } from '../utils/datetime';

interface DaemonSetEventsPanelProps {
  events: DaemonSetEvent[];
  loading?: boolean;
}
...
const DaemonSetEventsPanel = (props: DaemonSetEventsPanelProps) => (
  <Show
    when={!props.loading}
    fallback={
  ...
  >
    <Show
      ...
      fallback={<p class="text-sm opacity-60">No events found for this daemonset.</p>}
    >
...
export default DaemonSetEventsPanel;
