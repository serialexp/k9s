...
interface DeploymentEventsPanelProps {
...
const DeploymentEventsPanel = (props: DeploymentEventsPanelProps) => (
  <Show
    when={!props.loading}
    fallback={
  ...
  >
    <Show
      ...
      fallback={<p class="text-sm opacity-60">No events found for this deployment.</p>}
    >
...
export default DeploymentEventsPanel;
