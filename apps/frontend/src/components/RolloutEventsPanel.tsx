...
import type { RolloutEvent } from '../lib/api';
import { formatRelativeTime } from '../utils/datetime';

interface RolloutEventsPanelProps {
  events: RolloutEvent[];
  loading?: boolean;
}
...
const RolloutEventsPanel = (props: RolloutEventsPanelProps) => (
  <Show
    when={!props.loading}
    fallback={
  ...
  >
    <Show
      ...
      fallback={<p class="text-sm opacity-60">No events found for this rollout.</p>}
    >
...
export default RolloutEventsPanel;
