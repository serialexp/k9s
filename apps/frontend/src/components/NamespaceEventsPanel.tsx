// ABOUTME: Events panel component displaying events within a Kubernetes namespace
// ABOUTME: Shows events from all resources in the namespace with object details

import { Show, For } from 'solid-js';
import type { NamespaceEvent } from '../lib/api';

interface NamespaceEventsPanelProps {
...
const NamespaceEventsPanel = (props: NamespaceEventsPanelProps) => (
  <div class="flex flex-col gap-4">
    <div class="flex items-center justify-between">
      <h2 class="text-lg font-semibold">Namespace Events</h2>
    ...
    <Show
      ...
      fallback={
        <Show when={!props.loading}>
          <p class="text-sm opacity-60">No events found in this namespace.</p>
        </Show>
      }
    >
      <div class="space-y-3">
...
export default NamespaceEventsPanel;
