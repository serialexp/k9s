...
import type { PodEvent } from '../lib/api';

interface PodEventsPanelProps {
  events?: PodEvent[];
  loading?: boolean;
}
...
const PodEventsPanel = (props: PodEventsPanelProps) => (
  <div class="flex flex-col gap-4">
    <div class="flex items-center justify-between">
      <h2 class="text-lg font-semibold">Pod Events</h2>
    ...
    <Show
      ...
      fallback={
        <Show when={!props.loading}>
          <p class="text-sm opacity-60">No events found for this pod.</p>
        </Show>
      }
    >
      <div class="space-y-3">
