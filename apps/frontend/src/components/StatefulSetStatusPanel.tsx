...
import type { StatefulSetStatus } from '../lib/api';
import { formatRelativeTime } from '../utils/datetime';

interface StatefulSetStatusPanelProps {
  status?: StatefulSetStatus;
  loading?: boolean;
}

const StatefulSetStatusPanel = (props: StatefulSetStatusPanelProps) => (
  <Show
    when={props.status}
    fallback={
      props.loading ? (
        ...
        <p class="text-sm opacity-60">Select a statefulset to view its status.</p>
      )
    }
  >
    {(status) => (
          ...
          <div class="card bg-base-200/60">
            <div class="card-body gap-3 text-sm">
              ...
              <div class="flex items-center justify-between gap-3">
                ...
                <span class="font-semibold">{status().currentReplicas}</span>
              </div>
              <div class="flex items-center justify-between gap-3">
...
export default StatefulSetStatusPanel;
