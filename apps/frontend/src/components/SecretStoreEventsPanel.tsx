...
import type { SecretStoreEvent } from '../lib/api';
import { formatRelativeTime } from '../utils/datetime';

interface SecretStoreEventsPanelProps {
  events: SecretStoreEvent[];
  loading?: boolean;
}
...
const SecretStoreEventsPanel = (props: SecretStoreEventsPanelProps) => (
  <Show
    when={!props.loading}
    fallback={
  ...
  >
    <Show when={props.events.length} fallback={<p class="text-sm opacity-60">No events found for this secret store.</p>}>
...
export default SecretStoreEventsPanel;
